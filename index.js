...
bot.on('guildMemberAdd', member => {
  member.guild.channels.cache.get('716939268504813578').send("Welcome to Midnight, <@" + member.user.id + ">! To get started, visit <#709238410732240906> and react then go on to <#716212510398873651>. Enjoy your stay! <:goodnight:716209532233318472> <:cheemspray:716217215275237427>"); 
});
